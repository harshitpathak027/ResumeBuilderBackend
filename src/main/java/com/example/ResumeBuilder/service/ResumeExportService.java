...
public class ResumeExportService {
    ...
    private String buildPreviewHtml(Long resumeId, boolean forPdf) {
        ...
        html.append("<style>")
            .append("@page{size:Letter;margin:0.5in 0.5in;padding:0;}")
            .append("*{margin:0;padding:0;box-sizing:border-box;}")
            .append("html,body{width:100%;height:100%;margin:0;padding:0;}")
            .append("body{font-family:'Times New Roman',Times,serif;background:#f3f4f6;color:#000;line-height:1.3;font-size:11pt;}")
            .append(".viewer{min-height:100vh;overflow-y:auto;-webkit-overflow-scrolling:touch;padding:12px;box-sizing:border-box;background:#f3f4f6;}")
            ...
            .append(".page{width:100%;margin:4px auto;background:#fff;padding:0.5in;box-sizing:border-box;}")
            .append("h1{margin:0 0 3px 0;font-size:24pt;line-height:1;text-align:center;font-weight:700;letter-spacing:1px;}")
            .append(".contact{margin:0 0 6px 0;text-align:center;font-size:10pt;line-height:1.3;word-break:break-word;}")
            .append(".section{margin:8px 0 0 0;page-break-inside:avoid;}")
            .append(".section h2{font-size:12pt;font-weight:700;margin:6px 0 3px 0;padding-bottom:1px;border-bottom:0.5pt solid #000;}")
            .append(".entry{margin:3px 0 5px 0;page-break-inside:avoid;}")
            .append(".row{display:flex;justify-content:space-between;gap:10px;align-items:flex-start;margin:0;}")
            .append(".title{font-weight:700;font-size:11pt;line-height:1.2;flex:1;}")
            .append(".right{font-weight:700;font-size:11pt;line-height:1.2;white-space:nowrap;text-align:right;}")
            .append(".subtitle{font-style:italic;font-size:10pt;line-height:1.2;margin:1px 0 0 0;}")
            .append("ul{margin:2px 0 0 20px;padding:0;list-style-type:disc;}")
            .append("li{margin:0;padding:0;font-size:10pt;line-height:1.25;}")
            .append("p{margin:2px 0;padding:0;font-size:10pt;line-height:1.25;}")
            .append(".skills-line{margin:2px 0;padding:0;}")
            .append(".skills-line strong{font-weight:700;}")
            .append("@media (max-width:768px){")
            .append("body{background:#ffffff;}")
            .append(".viewer{padding:0;background:#fff;}")
            ...
            .append("h1{font-size:20pt;letter-spacing:0.5px;}")
            .append(".contact{font-size:9pt;line-height:1.3;}")
            .append(".section{margin:8px 0 0 0;}")
            .append(".section h2{font-size:11pt;}")
            .append(".entry{margin:2px 0 5px 0;}")
            .append(".title{font-size:11pt;}")
            .append(".right{font-size:11pt;}")
            .append(".subtitle{font-size:10pt;}")
            .append("ul{margin:2px 0 0 16px;}")
            .append("li{font-size:10pt;}")
            .append("p{font-size:10pt;}")
            .append("}")
            .append("@media print{body{background:#fff;margin:0;padding:0;} html{margin:0;padding:0;} .viewer{height:auto;overflow:visible;padding:0;margin:0;background:#fff;} .action-bar{display:none;} .page{border:none;margin:0;padding:0.5in;max-width:none;background:#fff;}}")
            .append("</style>");
